    ...
    <div className="space-y-4">
      ...
      <div className="relative aspect-video rounded-lg overflow-hidden group">
        ...
        <button
          ...
          className="absolute left-4 top-1/2 transform -translate-y-1/2 bg-zen-beaver bg-opacity-50 text-white rounded-full p-2 opacity-0 group-hover:opacity-100 transition-opacity duration-300 hover:bg-opacity-70"
        >
        ...
        <button
          onClick={goToNext}
          className="absolute right-4 top-1/2 transform -translate-y-1/2 bg-zen-beaver bg-opacity-50 text-white rounded-full p-2 opacity-0 group-hover:opacity-100 transition-opacity duration-300 hover:bg-opacity-70"
        >
          <svg className="w-6 h-6" fill="none" stroke="currentColor" viewBox="0 0 24 24">
        ...
        <button
          ...
          className="absolute bottom-4 right-4 bg-zen-beaver bg-opacity-50 text-white rounded-full p-2 opacity-0 group-hover:opacity-100 transition-opacity duration-300 hover:bg-opacity-70"
        >
          {isPlaying ? (
        ...
        {/* Image Counter */}
        <div className="absolute bottom-4 left-4 bg-zen-beaver bg-opacity-50 text-white px-3 py-1 rounded-full text-sm">
